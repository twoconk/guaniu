...
public class PoemTangshiFragment extends Fragment {
    ...
    private void initStories() {
        Poem huluwa = new Poem("唐诗1 李白", "床前明月光", R.mipmap.xiongchumo);
        poems.add(huluwa);
        Poem qitiandashen = new Poem("唐诗2 李白", "床前明月光", R.mipmap.katong2);
        poems.add(qitiandashen);
        Poem sanguo = new Poem("唐诗3 李白", "床前明月光", R.mipmap.tonghua3);
        poems.add(sanguo);
    }
}
